...
class DisasterCycloneScreen extends StatefulWidget {
  _DisasterCycloneScreenState createState() => _DisasterCycloneScreenState();
}

class _DisasterCycloneScreenState extends State<DisasterCycloneScreen> {
